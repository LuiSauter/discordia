...
const LoadingHome = () => {
  return (
    <section className='fixed inset-0 z-30 h-screen w-screen grid place-content-center place-items-center bg-discord_channels_bg overflow-hidden select-none'>
